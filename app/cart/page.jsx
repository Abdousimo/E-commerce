              ...
              cart.map(item => {
                return(
                  <li className="flex items-center gap-4" key={item?.product?.id}>
                    ...
                    <div>
                      <h3 className="text-lg text-gray-900">{item?.product?.attributes?.title}</h3>

                      <dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
                        <div className='space-x-2'>
                          <dt className="inline text-xs">Category:</dt>
                          <dd className="inline text-xs">{item?.product?.attributes?.category}</dd>
                        </div>
                      </dl>
                    </div>
                    ...
                    <div>
                          ...
                          <dd className="inline font-bold">{item?.product?.attributes?.price}$</dd>
                        </div>
          ...
          <div className="mt-8 flex justify-end border-t border-gray-100 pt-8">
            <div className="w-screen max-w-lg space-y-4">
              ...
              <div className="flex justify-end">
                <button
                  onClick={()=>router.push(`/chekout?amount=${getTotalAmount()}`)}
