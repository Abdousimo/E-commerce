		...
		<Body style={main}>
			<Container style={container}>
				...
				<Text style={paragraph}>
					Thank you purchasing on Ismail Tech Ecommerce. Click on Below download button to download the all digital content
				</Text>
				...
				<Text style={paragraph}>
					Best,
					<br />
					The Ismail Tech team
				</Text>
				<Hr style={hr} />
				<Text style={footer}>Subscribe to Ismail Abderrezague</Text>
			</Container>
		</Body>
	</Html>
);
